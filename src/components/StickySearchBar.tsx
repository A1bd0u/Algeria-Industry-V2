    ...
    <>
      <div className="sticky top-24 z-40 bg-white/80 backdrop-blur-md border-b border-gray-200 py-4 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={cn("flex items-center space-x-4", i18n.language?.startsWith('ar') && "flex-row-reverse space-x-reverse")}>
            <div className="flex-1 relative group">
              <div className={cn(
                ...
                i18n.language?.startsWith('ar') ? "end-0 pe-6" : "start-0 ps-6"
              )}>
              ...
              <button
                ...
                className={cn(
                  ...
                  i18n.language?.startsWith('ar') ? "pe-14 ps-32 text-end" : "ps-14 pe-32 text-start"
                )}
              >
              ...
              <div className={cn(
                ...
                i18n.language?.startsWith('ar') ? "start-0 ps-2 space-x-reverse" : "end-0 pe-2"
              )}>
            ...
            <div className="hidden lg:flex items-center space-x-6">
               <div className={cn("flex items-center space-x-2 border-gray-200", i18n.language?.startsWith('ar') ? "border-r pe-6" : "border-l ps-6")}>
                 <div className="w-1.5 h-1.5 bg-success rounded-full animate-pulse" />
                 <span className="text-[10px] font-black text-primary uppercase tracking-widest leading-none">
                    {i18n.language?.startsWith('ar') ? '١٢.٥ ألف منتج عبر الإنترنت' : '12.5k Produits en ligne'}
                 </span>
               </div>
            </div>
          </div>
